...
exports.RuleRegistryService = exports.BEHAVIOUR_DIMENSIONS = exports.RULE_REGISTRY = void 0;
...
exports.BEHAVIOUR_DIMENSIONS = [
    {
        key: "privacyOrientation",
        name: "Privacy Orientation",
        description: "Preference for private, quiet spaces over shared/social spaces",
        factors: [
            "prefersQuiet",
            "primaryLifestyle",
            "householdSize",
...
class RuleRegistryService {
    constructor() {
        this.rules = [...exports.RULE_REGISTRY];
    }
    getRules() {
