...
let WhatsappController = class WhatsappController {
    ...
    async send(projectId, body) {
        return this.whatsappService.sendMessage(projectId, body.to, body.template, body.params);
    }
    async templates(projectId, query) {
...
exports.WhatsappController = WhatsappController = __decorate([
    ...
    (0, common_1.Controller)("projects/:projectId/whatsapp"),
